...
''')
  ...
  print(('\033[94m-'*50))
  print('')
  print(' \033[96m Author   : \033[95m FALCON')
  print('')
...
bannar ()
# input
input2=input('\033[92m Enter Your Code Name :\033[93m ') #code Name
input3=input('\033[92m Enter Logo Link : \033[93m') # logo 
input4=input('\033[92m Enter Your Team Name :\033[93m ') #Team name
part1='''<!doctype html>
<html lang="en">
  <head>
